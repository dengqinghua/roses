...
HTML
      ...
      def doc_code(doc_type, name)
        <<-HTML
<div>
  <embed src='https://drive.google.com/viewerng/viewer?embedded=true&url=https://github.com/dengqinghua/roses/raw/master/assets/doc/#{name}.#{doc_type}' style='width:100%; height:700px;'>
</div>
HTML
      end
